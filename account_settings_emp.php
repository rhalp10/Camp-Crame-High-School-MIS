...
<div class="container">
	...
	<div class="navigator" align="center">
		...
		if($level==3)
		{		
			include 'includes/mainNav_faculty.php'; 
		}
		else if($level==4)
		{
			include 'includes/mainNav_registrar.php'; 
		}
		?>
	</div>
				...
				<!-- CONTENTS -->
	  			<div class="Contents">
					<div style="position:relative; left:25px;">
						...
						<tr>
							<td   width="310">Personal Information</td><td  width="310" align="center"><img height=10 src="images/modify.ico"/>&nbsp;&nbsp;<a class="myLinks" href="update_personalinfo_emp.php?userid=<?php echo($_SESSION['userid']);?>" onclick="window.open(this.href, '_blank', 'left=0,top=0,toolbar=1,resizable=0,width=500,height=660'); return false;">Edit</a></td>
	...
	<div class="footerNav" align="center" >
		...
		if($level==3)
		{		
			include 'includes/footernav_faculty.php'; 
		}
		else if($level==4)
		{
			include 'includes/footernav_registrar.php'; 
		}
		?>		
	</div>
