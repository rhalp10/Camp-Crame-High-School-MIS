...
?>
	<script type="text/javascript">
		...
		<?php header("location:index_registrart.php"); ?>
	</script>
<?php
	}
	else
...
<div class="container">
	...
	<div class="navigator" align="center">
		<?php include 'includes/mainNav_Guest.txt'; ?>
	</div>
				...
				<!-- CONTENTS -->
	  			<div class="Contents">
					<div style="position:relative; left:25px;">
						...
						<?php  require_once('myFunctions.php'); displayEnrollmentStatus($_SESSION['uid']);?>
						</table>
						<br><br>
						<h1>Requirements</h1>
						<br/>
						<table class="curvedEdges" width="620" border="1" cellpadding="0" cellspacing="0" bordercolor="#FF6633">
						<td bgcolor="#FF6633"><div align="center"><strong><font color="#FFFFFF">Document Name</font></strong></div></td>
						<td width="10" bgcolor="#FF6633"><div align="center"><strong><font color="#FFFFFF">Received</font></strong></div></td>
						<td bgcolor="#FF6633"><div align="center"><strong><font color="#FFFFFF">Date</font></strong></div></td>
						<td bgcolor="#FF6633"><div align="center"><strong><font color="#FFFFFF">Incharge</font></strong></div></td>
						<?php require_once('myFunctions.php'); displayAllRequirements($_SESSION['userid'],$_SESSION['levelid']); ?>
						</table>
					</div>
		  		</div>
				<?php
	...
	<div class="footerNav" align="center" >
		<?php include 'includes/footernav_Guest.txt'; ?>
	</div>
