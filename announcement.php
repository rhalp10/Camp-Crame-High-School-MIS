...
<div class="container">
	...
	<div class="navigator" align="center">
		<?php if($level==4) {include 'includes/mainNav_registrar.php';} else if($level==3) {include 'includes/mainNav_faculty.php';} ?>
	</div>
					...
					<div style="position:relative; left:25px;width:630px;">
						...
						<fieldset>
							<table width="620" height="190" border="0" cellpadding="0" cellspacing="0">
								<tr>
									<td width="195"><div align="center"><a class="myLinks" href="create_announcement.php"><img src="images/newannouncement.png" width="70" height="70" title="Create"></a></div> <div align="center"><a class="myLinks" href="create_announcement.php">Add New</a></div></td>								
									<td width="195"><div align="center"><a class="myLinks" href="edit_announcement.php"><img src="images/updateannouncement.png" width="70" height="70" title="Edit Announcement"></a></div> <div align="center"><a class="myLinks" href="edit_announcement.php">Edit</a></div></td>
									<td width="195"><div align="center"><a class="myLinks" href="deactivate_announcement.php"><img src="images/deactivate.png" width="70" height="70" title="Announcement Activation"></a></div> <div align="center"><a class="myLinks" href="deactivate_announcement.php">Activation</a></div></td>			
									<td width="195"><div align="center"><a class="myLinks" href="view_all_announcement.php"><img src="images/viewannouncement.png" width="70" height="70" title="View All"></a></div> <div align="center"><a class="myLinks" href="view_all_announcement">View All</a></div></td>
								</tr>		
							</table>
						</fieldset>
					</div>
	...
	<div class="footerNav" align="center" >
		<?php if($level==4) {include 'includes/footernav_registrar.php';} else if ($level==3) {include 'includes/footernav_faculty.php';} ?>
	</div>
