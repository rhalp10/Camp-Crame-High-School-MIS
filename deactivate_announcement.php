...
<div class="container">
				...
				<!-- CONTENTS -->
	  			<div class="Contents">
					...
					<div style="position:relative; left:20px;">
						<br>			
						<h1>Announcement Activation</h1>
						<br>
						<form action="#" method="post">
							<?php require_once('myFunctions.php'); displayDeactivateAnnouncement($_SESSION['uid']); ?>
						</form>
					<br>
	...
	<div class="footerNav" align="center" >
		<?php if($level==4){include 'includes/footernav_registrar.php';} {include 'includes/footernav_faculty.php';} ?>
	</div>
