...
?>
						...
						<form method="post" action="edit_announcement_exec.php" onSubmit="return checkForm(this); return false;">
						<input type="hidden" name="id" value="<?php  echo $id; ?>">
						<table class="PreRegMasterList" width="620" border="1" cellpadding="0" cellspacing="0" bordercolor="#FF6633">
							<td colspan=22 bgcolor="#FF6633"><div align="center"><strong><font color="#FFFFFF">Announcement Details</font></strong></div></td>			
							<tr>
								<td>Title:</td><td><input autofocus type="text" value="<?php echo $title; ?>" name="title" size="65" placeholder="Announcement Title"></td>
							</tr>
							<tr>
								<td>What:</td><td><input type="text" value="<?php echo $what; ?>" name="what" size="65" placeholder="What is the Announcement all about?"></td>
							</tr>
							<tr>
								<td>Where:</td><td><input type="text"  value="<?php echo $venue; ?>" name="where" size="65" placeholder="Where it will be held?"></td>
							</tr>
							<tr>
								<td>When:</td><td><input type="date" value="<?php echo date('Y-m-d',strtotime($eventdate)); ?>" name="when"></td>
							</tr>
							<tr>
								<td>Who:</td><td><input type="text"  value="<?php echo $who; ?>"name="who" size="65" placeholder="Who are the participants?"></td>
							</tr>
							<tr>
								<td>Deactivation Date:</td><td><input type="date" value="<?php echo date('Y-m-d',strtotime($expiry)); ?>" name="expirydate"></td>
							</tr>
							<tr>
								<td colspan=2 align="right"><input style="width: 60px; height: 30px;" type="submit" name="button" id="button" value="Update"></td>
							</tr>
						</table>
						</form>
					<br>
					<a class="myLinks" href="edit_announcement.php"><< Go Back</a>
					</div>
		  		</div>
				<?php
					}
	...
	<div class="footerNav" align="center" >
		<?php if($level==4){include 'includes/footernav_registrar.php';}  else { include 'includes/mainNav_faculty.php';}?>
	</div>
