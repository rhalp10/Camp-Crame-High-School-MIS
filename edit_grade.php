				...
				<!-- CONTENTS -->
	  			<div class="Contents">				
					<div style="position:relative; left:20px;">  
						...
						<br>
						<form action="faculty_search_student_grade.php" method="POST" onSubmit="return checkForm(this); return false;" >
							<table class="curvedEdges" width="620" border="1" cellpadding="0" cellspacing="0" bordercolor="#FF6633">
								...
								<tr>
									<td colspan=2 align="right"><input style="width: 60px; height: 30px;" type="submit" name="button" id="button" value="Find">&nbsp;&nbsp;&nbsp;<a href="edit_grade.php"><input style="width: 60px; height: 30px;" type="button" name="showall" value="Show All"></a>&nbsp;&nbsp;&nbsp;<input style="width: 60px; height: 30px;" type="reset" name="reset" id="reset" value="Clear"></td>
								</tr>
							</table>
							<br>
						</form>	
						<?php require_once('myFunctions.php'); displayStudentViewEditGrade($_SESSION['uid']); ?>
						<br>
