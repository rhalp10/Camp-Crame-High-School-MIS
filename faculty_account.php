				...
				<!-- CONTENTS -->
	  			<div class="Contents">
					<div style="position:relative; left:25px;"> 	
						...
						<tr>
							<td align="justify">Employee No. :</td><td><input autofocus onKeyPress="return isNumericKey(event);" maxlength=7 type="text" name="empno" placeholder="Enter Employee Number here..." size="65"></td>
						</tr>
						<tr>
