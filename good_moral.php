				...
				<!-- CONTENTS -->
	  			<div class="Contents">
					<div style="position:relative; left:25px;">
						...
						<br>
						<form action="print_good_moral.php" method="post"  onSubmit="return checkForm(this); return false;">
						...
						<tr>
							<td>LRN :</td><td><input autofocus type="text" name="lrn" placeholder="Enter LRN here ..." size=65/></td>
						</tr>
						<tr>
