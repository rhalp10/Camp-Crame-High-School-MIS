				...
				<!-- CONTENTS -->
	  			<div class="ContentsIndex">
					...
					<div style="left:-250px;"> 
						<br>						
						<h1>Online Management Information System</h1>
						<br>
						<img src="images/mission.jpg" width="128" height="128"  align="left">
						<br/>
						<p align="justify">
							<span class="firstcharacter">M</span> ission: 
							<?php require_once("schoolinfo.php"); displaySchoolMission(); ?>
						</p>
						<br/><br/><br/><br/>
						<img src="images/vision.jpg" width="128" height="128"  align="right">
						<br/><br/>
						<p align="justify">
							<span class="firstcharacter">V</span> ision: 
							<?php require_once("schoolinfo.php");  displaySchoolVision(); ?>
						</p>
