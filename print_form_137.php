...
<head>
	...
	{
		if (f.elements['studname'].value == "" )
		{
			alert("Student Name is missing!");
			f.elements['studname'].focus();
			return false;
		}
		else if (f.elements['sy'].value == "" )
		{
			alert("School Year is missing!");
			f.elements['sy'].focus();
			return false;
		}	
		else
				...
				<!-- CONTENTS -->
	  			<div class="Contents">
					<div style="position:relative; left:25px;">
						...
						<h1>Form 1-37</h1>
						<br>
						<form action="print_form_137_exec.php" method="post"  onSubmit="return checkForm(this); return false;">
						<table class="PreRegMasterList" width="620" border="1" cellpadding="0" cellspacing="0" bordercolor="#FF6633">
						<td colspan=2 bgcolor="#FF6633"><div align="center"><strong><font color="#FFFFFF">Search Student</font></strong></div></td>
						<tr>
							<td>LRN:</td><td><input autofocus type="text" onKeyPress="return isNumericKey(event);" name="lrn" placeholder="Enter LRN here ..." maxlength="12" size=65/></td>
						</tr>
						<tr>
							<td colspan=2 align="right"><input style="width: 60px; height: 30px;" type="submit" name="button" id="button" value="Go">&nbsp;&nbsp;&nbsp;<input style="width: 60px; height: 30px;" type="reset" name="reset" id="reset" value="Clear"></td>
						</tr>
						</table>
						</form>
					<br>
					<a class="myLinks" href="student_reports.php"><< Go Back</a>
					</div>
					</div>
				<?php
					}
