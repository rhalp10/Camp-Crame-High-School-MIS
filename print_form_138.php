				...
				<!-- CONTENTS -->
	  			<div class="Contents">
					<div style="position:relative; left:25px;">
						<br>			
						<h1>Print Form 138</h1>
						<br>
						<form action="print_form_138_exec.php" method="post"  onSubmit="return checkForm(this); return false;">
						...
						<tr>
							<td>LRN:</td><td><input autofocus onKeyPress="return isNumericKey(event);" type="text" name="lrn" placeholder="Enter LRN here ..." maxlength="12" size=65/></td>
						</tr>
						<tr>
