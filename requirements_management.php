				...
				<!-- CONTENTS -->
	  			<div class="Contents">				
					<div style="position:relative; left:25px;">  
						...
						<br>
						<form action="add_requirements_exec.php" method="POST" onSubmit="return checkForm(this); return false;" >
							<table class="curvedEdges" width="620" border="1" cellpadding="0" cellspacing="0" bordercolor="#FF6633">
								<td colspan=2 bgcolor="#FF6633"><div align="center"><strong><font color="#FFFFFF">Add New Document</font></strong></div></td>
								<tr>
									<td>Registration Type:</td>
									<td><select autofocus name="regid" id="regid" ><?php require_once("myFunctions.php"); displayRegistrationType(); ?></select></td>
								</tr>
								<tr>
									<td>Name:</td>
									<td><input type="text" placeholder="Enter Document Name here..." name="docname" size="60"></td>
								</tr>
								<tr>
									<td>Type:</td>
									<td >
								...
								<tr>
									<td colspan=2 align="right"><input style="width: 60px; height: 30px;" type="submit" name="button" id="button" value="Save">&nbsp;&nbsp;&nbsp;<input style="width: 60px; height: 30px;" type="reset" name="reset" id="reset" value="Clear"></td>
								</tr>
							</table>
							</form>	
							<br>
							<table class="curvedEdges" width="620" border="1" cellpadding="0" cellspacing="0" bordercolor="#FF6633">
								<td colspan=9 bgcolor="#FF6633"><div align="center"><strong><font color="#FFFFFF">Masterlist of Requirements</font></strong></div></td>
								<tr>
									<th>Registration</th>
									<th>Document Name</th>
									<th>Type</th>								
								...
								<?php require_once('myFunctions.php'); displayRequirementsMasterlist(); ?>
							</table>							
							<br>
							<?php require_once('myFunctions.php'); displayPageRequirementstMasterlist(); ?>
						<br><br>
