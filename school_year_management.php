...
<head>
	...
	<script language='javascript'>
		function updateSY(syId)
		{
			var newName=prompt('Enter new School Year:','');
			if (newName==null)
			{				
				return false;
			}
			...
			if (newName!="")
			{
				...
				if(ans==true)
				{
					window.location="update_school_year_exec.php?syid="+syId+"&&new="+newName;
				}
				else
				{
					return;
	...
	<script language='javascript'>
		function makeDefault(syId)
		{
			var ans=confirm('Are you sure you want to make this School Year as default?');
			if(ans==true)
			{
				window.location="update_school_year_default.php?syid="+syId;
			}
			else
			{
				return;
				...
				<!-- CONTENTS -->
	  			<div class="Contents">				
					<div style="position:relative; left:25px;">
						<br>			
						<h1>School Year Management (<?php  require_once('myFunctions.php'); displayCurrentSY(); ?>)</h1>
						<br>
						<form action="add_school_year_exec.php" method="POST" onSubmit="return checkForm(this); return false;" >
							<table class="curvedEdges" width="620" border="1" cellpadding="0" cellspacing="0" bordercolor="#FF6633">
								<td colspan=4 bgcolor="#FF6633"><div align="center"><strong><font color="#FFFFFF">Add New School Year</font></strong></div></td>
								<tr>
									<td>School Year:</td><td colspan=3><input autofocus type="text" placeholder="Enter School Year here..." name="syname" size="65"></td>
								<tr>
								<tr>
							...
							<br>
							<table class="curvedEdges" width="620" border="1" cellpadding="0" cellspacing="0" bordercolor="#FF6633">
								<td colspan=4 bgcolor="#FF6633"><div align="center"><strong><font color="#FFFFFF">Masterlist of School Year</font></strong></div></td>
								<tr>
									<th>School Year</th>
									<th>Status</th>
									<th colspan=2>Actions</th>
								</tr>
								<?php require_once('myFunctions.php'); displaySYMasterlist(); ?>
							</table>
							<br>
							<?php require_once('myFunctions.php'); displayPageSY(); ?>
						<br><br>
