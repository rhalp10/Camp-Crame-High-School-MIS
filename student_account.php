				...
				<!-- CONTENTS -->
	  			<div class="Contents">
					<div style="position:relative; left:25px;">
						...
						<br>
						<form method="POST" action="student_account_reset_exec.php" onSubmit="return checkControl(this); return false;">
						<table class="curvedEdges" width="620" border="1" cellpadding="0" cellspacing="0" bordercolor="#FF6633">
						<td colspan=2 bgcolor="#FF6633"><div align="center"><strong><font color="#FFFFFF">Student Account Reset</font></strong></div></td>
						<tr>
							<td align="justify">LRN :</td><td><input autofocus type="text" onKeyPress="return isNumericKey(event);" name="lrn" placeholder="Enter LRN here..." size="65"></td>
						</tr>
						<tr>
