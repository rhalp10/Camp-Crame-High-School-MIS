	  			...
	  			<div class="Contents">		
					<div style="position:relative; left:25px;">
						...
						<table class="curvedEdges" width="620" border="1" cellpadding="0" cellspacing="0" bordercolor="#FF6633">
							<td colspan=3 bgcolor="#FF6633"><div align="center"><strong><font color="#FFFFFF">My Grades</font></strong></div></td>
							<tr>
								<th>Grade Level</th><th>School Year</th><th>Action</th>
							</tr>
							<?php require_once('myFunctions.php'); GetStudentGradeLevel($_SESSION['uid']); ?>
						</table>
						<br/>
					</div>
		  		</div>
