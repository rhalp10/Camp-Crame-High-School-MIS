	  			...
	  			<div class="Contents">				
					<div style="position:relative; left:25px;">
						...
						<table class="curvedEdges" width="620" border="1" cellpadding="0" cellspacing="0" bordercolor="#FF6633">
							<td colspan=2 bgcolor="#FF6633"><div align="center"><strong><font color="#FFFFFF"><?php require_once('myFunctions.php'); displayGradeLevelDesc($_GET['gradeid']); ?></font></strong></div></td>
							 <?php require_once('myFunctions.php'); displaySubjectsGrade($_SESSION['uid'],$_GET['gradeid'],$_GET['syid']); ?>
						</table>
						<br/>
					</div>
		  		</div>
