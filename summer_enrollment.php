				...
				<!-- CONTENTS -->
	  			<div class="Contents">				
					<div style="position:relative; left:25px;">  
						<br>			
						<h1>Summer Class Enrollment</h1>
						<br>				
						
						<form action="update_student_summer.php" method="POST" onSubmit="return checkForm(this); return false;" >
							<table class="curvedEdges" width="620" border="1" cellpadding="0" cellspacing="0" bordercolor="#FF6633">
								<td colspan=2 bgcolor="#FF6633"><div align="center"><strong><font color="#FFFFFF">Enter Student Information</font></strong></div></td>
								<tr>
									<td>LRN:</td>
									<td><input autofocus type="text" placeholder="Enter LRN here..." name="lrn" size="60" maxlength=12 ></td>
								</tr>
								<tr>
									<td>Grade Level:</td>
									<td><select name="gradeid"><?php require_once('myFunctions.php'); displaySummerClasses(); ?></select></td>
								</tr>
								<tr>
