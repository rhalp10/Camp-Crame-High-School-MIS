...
<head>
 ...
 <script type="text/javascript">
   function update(str)
   {
      ...
      xmlhttp.open("GET","section_grade_level.php?opt="+str, true);
      xmlhttp.send();
  }
</script>	
 <script type="text/javascript">
   function update1(str)
   {
      ...
      xmlhttp.open("GET","subject_grade_level.php?opt="+str;, true);
      xmlhttp.send();
  }
</script>	
	<style>
...
<div class="container">
	...
	<div class="navigator" align="center">
		<?php include 'includes/mainNav_faculty.php'; ?>
	</div>
				...
				<!-- CONTENTS -->
	  			<div class="Contents">
					<div style="position:relative; left:20px;"> 
						...
						<h1>Upload Grade</h1>
						<br>
						<form enctype="multipart/form-data" action="upload_grade_step1.php" method="POST">
							<table class="curvedEdges" width="620" border="1" cellpadding="0" cellspacing="0" bordercolor="#FF6633">
								<td colspan=2 bgcolor="#FF6633"><div align="center"><strong><font color="#FFFFFF">Select Subject and CSV File</font></strong></div></td>
								<tr>
									<td>School Year:</td><td><?php require_once('myFunctions.php'); displayCurrentSY(); ?></td>
								</tr>								
								<tr>
									<td>Grade Level:</td><td><select onchange="update(this.value)"  name="gradeid"><?php require_once('myFunctions.php');  displayGradeLevelFaculty($_SESSION['uid']); ?></select></td>
								</tr>
								<tr>
									<td>Section:</td>
									<td><select name="secid"  id="data"><?php require_once("myFunctions.php"); displaySectionInitial1(); ?></select></td>
								</tr>							
								<tr>
									<td colspan=2 align="right"><input style="width: 60px; height: 30px;" type="submit" name="button" id="button" value="Next">&nbsp;&nbsp;&nbsp;<input style="width: 60px; height: 30px;" type="reset" name="reset" id="reset" value="Clear"></td>
								</tr>
							</table>
						</form>
					<br>
					
					<a href="grading_system.php" class="myLinks"><< Go Back</a>
					</div>
					</div>
				<?php
					}
	...
	<div class="footerNav" align="center" >
		<?php include 'includes/footernav_faculty.php'; ?>
	</div>
