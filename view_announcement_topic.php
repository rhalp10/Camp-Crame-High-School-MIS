...
<div class="container">
	...
	<div class="navigator" align="center">
		<?php  if($level==4){include 'includes/mainNav_registrar.php';} else if($level==3) {include 'includes/mainNav_faculty.php';} else if($level==2) {include 'includes/mainNav_student.php';} else if($level==1 ||$level==5) {include 'includes/mainNav_Guest.txt';} else {include 'includes/mainNav_faculty.php';} ?>
	</div>
				...
				<!-- CONTENTS -->
	  			<div class="Contents">
					...
					<div style="position:relative; left:20px;">
						...
						<br>
						<?php require_once('myFunctions.php'); displaySelectedAnnouncementTopic($_GET['id']);  ?>
						</form>
					</div>
		  		</div>
				<?php
	...
	<div class="footerNav" align="center" >
		<?php if($level==4) {include 'includes/footernav_registrar.php';} else if($level==3){include 'includes/footernav_faculty.php';} else if($level==2){include 'includes/footernav_student.php';} else if($level==1 || $level==5){include 'includes/footernav_Guest.txt';} else {include 'includes/footernav_faculty.php';} ?>
	</div>
