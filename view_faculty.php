				...
				<!-- CONTENTS -->
	  			<div class="Contents">				
					<div style="position:relative; left:25px;">
						...
						<h1>View Faculty</h1>
						<br>
						<form action="registrar_search_faculty.php" method="POST" onSubmit="return checkForm(this); return false;" >
							<table class="curvedEdges" width="620" border="1" cellpadding="0" cellspacing="0" bordercolor="#FF6633">
								...
								<tr>
									...
									<td>
										<select autofocus name="criteria">
											<option value="employeeid">Employee No.</option>
								...
								<tr>
									<td>Keyword:</td>
									<td><input type="text" name="term" placeholder="Enter keyword here..." size="65"></td>
								</tr>
								<tr>
									<td colspan=2 align="right"><input style="width: 60px; height: 30px;" type="submit" name="button" id="button" value="Find">&nbsp;&nbsp;&nbsp;<a href="view_faculty.php"><input style="width: 60px; height: 30px;" type="button" name="showall" value="Show All"></a>&nbsp;&nbsp;&nbsp;<input style="width: 60px; height: 30px;" type="reset" name="reset" id="reset" value="Clear"></td>
								</tr>
							</table>
							<br>
						</form>	
						<?php require_once('myFunctions.php'); displayFacultyView();?>
						<br>
