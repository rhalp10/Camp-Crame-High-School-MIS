				...
				<!-- CONTENTS -->
	  			<div class="Contents">				
					<div style="position:relative; left:25px;">
						<br>			
						<h1>Faculty Masterlist</h1>
						<br>
						<form action="registrar_search_faculty_masterlist.php" method="POST" onSubmit="return checkForm(this); return false;" >
							<table class="curvedEdges" width="620" border="1" cellpadding="0" cellspacing="0" bordercolor="#FF6633">
								...
								<tr>
									<td colspan=2 align="right"><input style="width: 60px; height: 30px;" type="submit" name="button" id="button" value="Go">&nbsp;&nbsp;&nbsp;<a href="view_faculty_list.php"  target="_blank"><input style="width: 60px; height: 30px;" type="button"value="Print"></a>&nbsp;&nbsp;&nbsp;<input style="width: 60px; height: 30px;" type="reset" name="reset" id="reset" value="Clear"></td>
								</tr>
							</table>
							<br>
						</form>	
						<?php require_once('myFunctions.php'); displayFacultyMasterList();?>
						<br>
