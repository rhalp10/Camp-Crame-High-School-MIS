...
<?php	
	...
	else
	{
		...
		do {
			...
			$result = mysql_query("SELECT sm.lrn, um.lname, um.fname, um.mname FROM usermaster as um, studentmaster as sm WHERE um.userid=sm.userid and sm.gradeid=$gradeid and sm.sectionid=$sectionid AND sm.sex=$gender order by um.lname asc");
