				...
				<!-- CONTENTS -->
	  			<div class="Contents">				
					<div style="position:relative; left:20px;"> 
						<br>			
						<h1>View Uploaded Grades</h1>
						<br>
						<form action="faculty_search_grade.php" method="post">
						<table class="curvedEdges" width="620" border="1" cellpadding="0" cellspacing="0" bordercolor="#FF6633">
							<td colspan=2 bgcolor="#FF6633"><div align="center"><strong><font color="#FFFFFF">Select Criteria</font></strong></div></td>
							<tr><td>Search By:</td>
								<td>
									<select name="criteria">
										<option value="gradeid">Grade Level</option>
							...
							<tr>
								<td>Keyword:</td>
								<td><input type="text"placeholder="Enter keyword here..." name="keyword" size="65"></td>
							</tr>
							<tr>
								<td colspan=2 align="right"><input style="width: 60px; height: 30px;" type="submit" name="button" id="button" value="Go">&nbsp;&nbsp;&nbsp;<a href="view_student_grade.php"><input style="width: 60px; height: 30px;" type="submit" name="button" id="button" value="Show All"></a>&nbsp;&nbsp;&nbsp;<input style="width: 60px; height: 30px;" type="reset" name="reset" id="reset" value="Clear"></td>
							</tr>
						</table>
						</form>
						<br>
						<?php require_once('myFunctions.php'); displayStudentGrades(); ?>
						<br>
