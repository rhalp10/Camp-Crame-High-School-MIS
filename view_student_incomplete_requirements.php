				...
				<!-- CONTENTS -->
	  			<div class="Contents">				
					<div style="position:relative; left:25px;">
						...
						<br>
						<form action="registrar_search_student_incomplete_requirements.php" method="POST" onSubmit="return checkForm(this); return false;" >
							<table class="curvedEdges" width="620" border="1" cellpadding="0" cellspacing="0" bordercolor="#FF6633">
								...
								<tr>
									<td>LRN:</td>
									<td><input autofocus maxlength=12 onKeyPress="return isNumericKey(event);" type="text" name="lrn" placeholder="Enter LRN here..." size="65"></td>
								</tr>
								<tr>
									<td colspan=2 align="right"><input style="width: 60px; height: 30px;" type="submit" name="button" id="button" value="Find">&nbsp;&nbsp;&nbsp;<a href="view_student_incomplete_requirements.php"><input style="width: 60px; height: 30px;" type="button" name="showall" value="Show All"></a>&nbsp;&nbsp;&nbsp;<input style="width: 60px; height: 30px;" type="reset" name="reset" id="reset" value="Clear"></td>
								</tr>
							</table>
							<br>
						</form>	
						<?php require_once('myFunctions.php'); displayStudentIncompleteRequirements(); ?>
				
						<br>
						<a href="student_management.php" class="myLinks"><< Go Back</a></div>
					</div>
				<?php
					}
				?>
