	  			...
	  			<div class="Contents">
					...
					<div style="position:relative; left:8px;"> 
						<br>
							...
							<br>
							<table style="background: url(images/bg.jpg) repeat-x;" border="0" width="650">
							<?php require_once('myFunctions.php'); displayStudent($_GET['id']); ?>
							</table>
							<br>
							<a class="myLinks" href="view_student.php"><< Go Back</a>
