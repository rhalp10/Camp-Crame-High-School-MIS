				...
				<!-- CONTENTS -->
	  			<div class="Contents">				
					<div style="position:relative; left:25px;">
						...
						<br>
						<form action="registrar_search_student_masterlist.php" method="POST" onSubmit="return checkForm(this); return false;" >
							<table class="curvedEdges" width="620" border="1" cellpadding="0" cellspacing="0" bordercolor="#FF6633">
								...
								<tr>
									<td>Search By:</td>
									<td>
										<select autofocus name="fieldname">
								...
								<tr>
									...
									<td>
										<select name="sortfieldname">
											...
											<option value="description">Grade Level</option>
						...
						<?php require_once('myFunctions.php'); displayStudentMasterList();?>
						<br>
