				...
				<!-- CONTENTS -->
	  			<div class="Contents">				
					<div style="position:relative; left:25px;">
						...
						<br>
						<form action="registrar_transfer_student_section.php" method="POST" onSubmit="return checkForm(this); return false;" >
